...
parquet_dir = '/fsx/home-thaottn/dataset2metadata/100M_pool_coca_captions_no_ft_temp_0.5' #TODO: update this

job_dir = 'examples/jobs_coca_temp_0.5_no_ft/' #TODO: update this
...
fs, output_path = fsspec.core.url_to_fs(f'{parquet_dir}/100M_coca_captions_metadata.json')
